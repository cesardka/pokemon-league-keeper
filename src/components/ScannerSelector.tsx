...
export function ScannerSelector({ eventId, rounds }: ScannerSelectorProps) {
      ...
      <div className="flex flex-col flex-1 bg-gray-900">
        <div className="flex-1 flex flex-col items-center justify-center p-6">
          ...
          <div className="grid gap-4 w-full max-w-sm">
            {/* Camera Option */}
            <button
              onClick={() => selectMode("camera", false)}
          ...
          <p className="text-xs text-gray-500 mt-6 text-center">
            You can change this later by tapping the scanner icon
          </p>
        </div>
      </div>
    );
  ...
  // Active scanner with mode switcher
  return (
    <div className="flex flex-col flex-1 relative">
      {/* Mode Switch Button */}
      <button
        onClick={switchMode}
        className="absolute top-2 right-2 z-40 p-2 bg-gray-800/80 hover:bg-gray-700 rounded-lg border border-gray-600 transition-colors"
