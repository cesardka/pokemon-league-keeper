...
export default async function DashboardPage() {
  ...
  const activeEvents = events.filter(
    (e: EventWithCounts) => e.status === "ACTIVE",
  );
  const pastEvents = events.filter(
    (e: EventWithCounts) => e.status === "COMPLETED",
  );
          ...
          <div className="grid gap-4">
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: "url('/art/bills-transfer-sv35-art.webp')",
                }}
              />
              <span className="relative z-10">SEND TO TOM</span>
            </Link>
            ...
            >
              ...
              />
              <span className="relative z-10">SCAN MATCH SLIPS</span>
            </Link>
          </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          ...
                          {event._count.rounds} rounds • {event._count.barcodes}{" "}
                          scans
                        </p>
                      </div>
